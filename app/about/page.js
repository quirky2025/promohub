    ...
    <div style={{ background: '#fff', fontFamily: '"DM Sans", sans-serif' }}>
      ...
      <div style={{ background: NAVY, padding: '80px 40px', textAlign: 'center' }}>
        <div style={{ maxWidth: '660px', margin: '0 auto' }}>
          <p style={{ fontFamily: '"Cormorant Garamond", Georgia, serif', fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 600, color: '#ffffff', lineHeight: 1.3, marginBottom: '16px' }}>
            Easy. Fast. Transparent. Custom.
          </p>
          <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.82)', lineHeight: 1.7, marginBottom: '40px' }}>
          ...
          <Link href="/promotional-products" style={{ display: 'inline-block', background: GOLD, color: '#fff', padding: '16px 40px', borderRadius: '8px', textDecoration: 'none', fontWeight: 700, fontSize: '15px', letterSpacing: '0.5px' }}>
            Browse Our Products
          </Link>
        </div>
      </div>
