...
// Free-text source: product.materials AND product.name (e.g. "Cotton Canvas Tote",
// "Non-Woven Shopper", "Poly Tote", "Recycled Polyester (rPET)"). Surfaces EVERY
// family mentioned (option 1). Word-boundary regex so "poly" matches "Poly Tote"
// but NOT "polypropylene". Precedence: recycled -> RPET (not Polyester);
// non-woven -> Non-Woven (not Plastic). "Juco" = jute+cotton blend -> both.
const MATERIAL_TEXT = [
  ...
  ['Metal',     /\bmetal\b|\balumini?um\b|\bstainless\b|\bsteel\b|\btin\b/],
