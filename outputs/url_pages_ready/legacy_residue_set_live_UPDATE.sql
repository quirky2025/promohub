-- Set legacy-residue-supported flat URL pages live
-- Run only after legacy_residue_live_preflight_READONLY.sql has acceptable product counts.
-- This sets only target url_pages rows with non-zero published product counts to live.
