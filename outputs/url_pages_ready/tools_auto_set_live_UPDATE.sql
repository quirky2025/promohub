-- Set Tools & Auto flat URL pages live
-- Run only after tools_auto_live_preflight_READONLY.sql has acceptable product counts.
-- This updates only Tools & Auto url_pages rows with non-zero product counts.
