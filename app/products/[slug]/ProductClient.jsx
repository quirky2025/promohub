...
export default function ProductClient({ product, mainImage, colours, extraImages, pricingTiers, brandingDecorations, addonDecorations }) {
  ...
  const allDecorations = [...(brandingDecorations || []), ...(addonDecorations || [])];
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '32px 40px 60px', display: 'grid', gridTemplateColumns: '480px 1fr', gap: '48px', alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          {addonDecorations.length > 0 && (
            <div>
              <StepLabel num={colours.length > 0 ? (brandingDecorations.length > 0 ? 4 : 3) : (brandingDecorations.length > 0 ? 3 : 2)} text="Add-ons & Extras" />
              <div style={{ border: '1px solid #E0DDD7', borderRadius: '10px', overflow: 'hidden', marginTop: '10px' }}>
