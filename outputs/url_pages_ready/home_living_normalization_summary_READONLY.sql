-- Home & Living normalization summary
-- READ ONLY. Run before home_living_normalization_apply_UPDATE.sql.
-- Goal:
--   Preview old Home / Leisure homeware cleanup for the flat URL rollout.
--   Home & Living keeps homewares only:
--     Kitchen & Dining / Cheese & Serving Boards / Home Decor / Candles & Diffusers.
--   Obvious non-homeware rows are routed out:
--     barware -> Barware & Accessories
--     outdoor towels / picnic blankets / yoga mats -> Outdoor & Sports
--     pet items -> Pet
--     bags -> Bags
