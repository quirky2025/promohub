...
const brandingLabel = (d, setupQty) => isColourMethod(d) ? `${d.name} — ${isOneColourLocked(d) ? 1 : (setupQty || 1)} colour · 1 position` : `${d.name} — Full Colour · 1 position`;
            ...
            {product && (
              <>
                ...
                <div>
                  ...
                  <textarea value={notes} onChange={e => setNotes(e.target.value)} rows={2} placeholder="Optional notes shown internally…" style={{ ...inp, resize: 'vertical' }} />
                </div>
