...
export async function generateOrderDocPDF(o) {
  ...
  page.drawText(`Production lead time is ${o.leadTimeDays || 7} business days from artwork approval and full payment.`, { x: 40, y: y - 26, size: 8.5, font: fR, color: BLACK });
  page.drawText('We start production once you approve your free digital proof.', { x: 40, y: y - 39, size: 8.5, font: fR, color: BLACK });
