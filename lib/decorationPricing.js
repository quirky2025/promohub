...
export const FINISHING = [
  { key: 'swing_tag', label: 'Swing tag', per_unit: 0.30 },
  { key: 'apply_barcode', label: 'Apply barcode', per_unit: 0.30 },
  { key: 'fold_bag', label: 'Fold & bag', per_unit: 1.00, per_unit_fleece: 1.20 },
  { key: 'individual_bags', label: 'Individually bagged', per_unit: 0.20 },
];
