...
import { resolveCollectionProducts, getMaterialCollections } from '@/lib/smartCollections';

// Category-page "Shop by material" chips (published attribute collections).
export async function getMaterialCollectionLinks(category) {
  return getMaterialCollections(supabase, category);
}
...
export const PRODUCT_SELECT = `
  ...
  supplier_sku, decoration_model, supplier, colour_slugs, fulfillment, capacity, pen_mechanism, pen_ink_colour, material_tags, materials, quote_only, quote_ref_price, pricing_tiers ( min_qty, base_price ), decoration_options ( name, type )
`;
