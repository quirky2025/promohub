...
export const PRODUCT_SELECT = `
  ...
  decoration_model, supplier, colour_slugs, fulfillment, capacity, pen_mechanism, pen_ink_colour, material_tags, materials, pricing_tiers ( min_qty, base_price ), decoration_options ( name, type )
`;
